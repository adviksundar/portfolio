    ...
    <section id="works">
      ...
      <span className="worksDesc">
        ...
        <span className="direction">
          Click on a project below to see its source code
        </span>
      </span>
      <div className="worksImgs">
        <a
          href="https://github.com/adviksundar/Planet_Hunters_AI_Tool"
          target="_blank"
          className="overlay"
        >
          <div className="img">
        ...
        <a
          href="https://github.com/adviksundar/NLP_for_Finance_Sentiment_Analysis"
          target="_blank"
          className="overlay"
        >
          <div className="img">
            <img
              src={NLPFinance}
              alt="NLP for Finance Sentiment Analysis"
              className="worksImg"
            />
          </div>
          <div className="linkTxt">
        ...
        <a
          href="https://github.com/adviksundar/AI_Tool_and_Web_Application_for_Skin_Cancer_Diagnosis"
          target="_blank"
          className="overlay"
        >
          <div className="img">
            <img
              src={SkinCancer}
              alt="Skin Cancer Diagnosis AI Tool"
              className="worksImg"
            />
          </div>
          <div className="linkTxt">
        ...
        <a
          href="https://github.com/adviksundar/Object_Detection_AI_Tool_for_Cars"
          target="_blank"
          className="overlay"
        >
          <div className="img">
            <img
              src={CarDetection}
              alt="Object Detection AI Tool for Cars"
              className="worksImg"
            />
          </div>
          <div className="linkTxt">
        ...
        <a
          href="https://github.com/adviksundar/EPL-Winner-Predictions"
          target="_blank"
          className="overlay"
        >
          <div className="img">
            <img
              src={EPLSoccer}
              alt="EPL Soccer Winner Predictor"
              className="worksImg"
            />
          </div>
          <div className="linkTxt">
        ...
        <a
          href="https://github.com/adviksundar/portfolio"
          target="_blank"
          className="overlay"
        >
          <div className="img">
        ...
        <a
          href="https://github.com/adviksundar/TranquilChat"
          target="_blank"
          className="overlay"
        >
          <div className="img">
            <img src={TranquilChat} alt="TranquilChat" className="worksImg" />
          </div>
          <div className="linkTxt">
            <h2>TranquilChat</h2>
          </div>
